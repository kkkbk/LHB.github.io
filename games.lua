...
*✧| » كت تويت ↤︎ لعبه التسليه* 
*✧| » انجليزي ↤︎ لعبه ترجمة انجليزي*
*✧| » تفكيك ↤︎ لعبه تفكيك الكلمات*
*✧| » تركيب ↤︎ لعبه تركيب الكلمات*
*✧| » رياضيات ↤︎ لعبة الرياضيات*
...
salemn = '['..(redis:get(boss"chencher"..msg.sender_user_id_) or '')..']'
...
'مين سرق اسمك القديم  '..salemn..' 😉 ',
'يا '..salemm..' اسمك القديم وين 😹'
}
